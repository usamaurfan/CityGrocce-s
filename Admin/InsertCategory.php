...
<h1 class="text-center my-4" style="color: green"><i class="fas fa-plus fa-md"></i> <span class="d-none d-sm-inline"> Add New </span> Category </h1>
<form action="" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
            <label for="pro_title" class="float-md-right"style="color: green"> <span class="d-sm-none d-md-inline"> Category </span> Title:</label>
        </div>
        ...
        <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
            <label for="pro_img" class="float-md-right"style="color: green"><span class="d-sm-none d-md-inline"> Category </span> Image:</label>
        </div>
        ...
        <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
            <label for="pro_desc" class="float-md-right"style="color: green"><span class="d-sm-none d-md-inline"> Category </span> Detail:</label>
        </div>
...
<div class="row my-3">
    ...
    <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
        <button type="submit" name="insert_cat" class="btn btn-dark btn-block"style="color: red"><i class="fas fa-plus"></i> Insert Now </button>
    </div>
</div>
