    ...
    <div class="offset-md-2 col-md-8">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group row">
                <h2 class="offset-lg-3 offset-md-2 offset-1 " style="color: green"> Edit & Update Category </h2>
            </div>

            <div class="form-group row">
                <label class="col-form-label col-sm-4 col-lg-3 d-none d-sm-block" for="cat_title" style="color: green">Category Title</label>
            ...
            <div class="form-group row">
                <label class="col-form-label col-sm-4 col-lg-3 d-none d-sm-block" for="cat_image"style="color: green">Category Image</label>
                <div class="col-12 col-sm-8 col-lg-9">
            ...
            <div class="form-group row">
                <label class="col-form-label col-sm-4 col-lg-3 d-none d-sm-block" for="cat_desc"style="color: green">Category Description</label>
                <div class="col-12 col-sm-8 col-lg-9">
            ...
            <div class="form-group row">
                <div class="offset-sm-3 col-12 col-sm-6">
                    <input class="btn btn-block btn-dark btn-lg" type="submit" id="update_cat" name="update_cat"
                           value="Update Category Now" style="color: red">
                </div>
            </div>
        </form>
    </div>
