...
<div id= "maincontent">
    ...
    <div class="col-md-4 offset-md-4 col-sm-6 offset-sm-3 col-xs-12">
        <form class="form-container bg-white"  method="post">
            <label style="margin: 18px 0px;font-weight: bold; font-size: small ;font-family: 'Hobo Std';color: red"><?php echo $error_msg;?></label>
            <h1 style="margin: 18px 0px;font-weight: bold; font-size: 70px;font-family: 'Hobo Std';color: green"> login</h1>
            <div class="form-group" style="margin: 0px 0px">
                <label for="login_exampleInputEmail1" class="float-left" style=" font-weight: bold; font-size: 15px;font-family: 'Hobo Std';color: green">Email </label>
            ...
            <div class="form-group" style="margin: 0px 0px">
                <label for="login_exampleInputPassword1"  class="float-left" style=" font-weight: bold; font-size: 15px;font-family: 'Hobo Std';color:green">Password</label>
            ...
            <button type="submit" class="btn btn-dark  btn-block" style=" margin-bottom: 10px;
            font-weight: bold; font-size: 15px;font-family: 'Hobo Std';color: red" name="login" id = "login">LogIn</button>
            <span style=" font-weight: bold; font-size: 15px;font-family: 'Hobo Std';color: green ;">
