...
<head>
    ...
    <meta name="author" content="Usama Chaudahry, Usama Zaid">
...
<div class="row signin">
    <div class="col-md-4 offset-md-4 col-sm-6 offset-sm-3 col-xs-12">
        <form class="form-containers bg-white"  method="post" enctype="multipart/form-data">
            ...
            <h1 style="margin: 18px 0px;font-weight: bold; font-size: 65px;font-family: 'Hobo Std';color: green">SignIn</h1>
            <div class="form-group" style="margin: 0px 0px">
                <label for="signin_username" class="float-left" style=" font-weight: bold; font-size: 15px;font-family: 'Hobo Std';color: green">UserName</label>
                <input type="text" class="form-control" required pattern = "[A-Za-z](\d|\w|\.|-){2,30}" name="signin_username" id="signin_user"  placeholder="UserName"
                       style=" font-weight: lighter; font-size: 15px;font-family: 'Hobo Std';color: black">
            </div>
            <div class="form-group" style="margin: 0px 0px">
                <label for="signin_exampleInputEmail" class="float-left" style=" font-weight: bold; font-size: 15px;font-family: 'Hobo Std';color: green">Email </label>

                <input type="email" class="form-control" id="signin_exampleInputEmail1" required pattern="(\d|\w|\.|-){1,30}@(gmail|yahoo|hotmail)\.com"
                       name="signin_exampleInputEmail1" placeholder="Email" style=" font-weight: lighter; font-size: 15px;font-family: 'Hobo Std';color: black"
                        onkeyup="checkEmail(this.value)">
                <span   id="hint" style="margin: 18px 0px;font-weight: bold; font-size: small ;font-family: 'Hobo Std';color: black"></span>
            </div>
            <div class="form-group" style="margin: 0px 0px">
                <label for="signin_exampleInputPassword1"  class="float-left" style=" font-weight: bold; font-size: 15px;font-family: 'Hobo Std';color: green">Password</label>
            ...
            <div class="form-group" style="margin: 0px 0px">
                <label for="signin_exampleInputPassword2"  class="float-left" style=" font-weight: bold; font-size: 15px;font-family: 'Hobo Std';color: green">Re-EnterPassword</label>
            ...
            <div class="checkbox" style="margin: 0px 0px">
                <label  class="float-left"style=" font-weight: bold; font-size: 15px;font-family: 'Hobo Std';color: green">
                    <input type="checkbox"id="remember" name="remember" > Remember me
                </label>
            </div>
            <button type="submit" class="btn btn-dark  btn-block" name="SignInButton" id="SignInButton" style=" font-weight: bold; font-size: 15px;font-family: 'Hobo Std';color: red">SignIn</button>
        </form>
    </div>
</div>
    </div>
